(function() {
  ...
  function Animated(world) {
    ...
    node.style.cssText = "position: relative; width: intrinsic; width: fit-content;margin: 0 auto;margin-top: 70px;box-shadow: 0 0 18px rgb(204, 200, 200);padding: 1px 14px 1px 14px;";
    ...
    this.button.style.cssText = "position: absolute; bottom: 1px; right: -4.5em; color: white; font-family: tahoma, arial; " +
      "background: rgb(0, 0, 0); cursor: pointer; border-radius: 18px; font-size: 75%; width: 3.5em; text-align: center;padding-bottom: 2px;";
